...
errors.makeConstructor('FolderAlreadyExistsError', {
    statusCode: 409,
    restCode: 2006
});
...
const messages =  {
    ...
    FolderNotFoundError: 'The folder %s does not exist in the folder tree of curriculum %s.',
    ...
    FolderAlreadyExistsError: 'There is already a folder called %s in the folder tree of curriculum %s.',
