...
function _initRoutes(server) {
    ...
    server.get(`${curriculaBasePath}/:curriculumId/folders`, controllers.folderController.findByPath);
    server.get(`${curriculaBasePath}/:curriculumId/folders/.*`, controllers.folderController.findByPath);

    server.post(`${curriculaBasePath}/:curriculumId/folders`, controllers.folderController.insert);
    server.post(`${curriculaBasePath}/:curriculumId/folders/.*`, controllers.folderController.insert);


    server.put(`${curriculaBasePath}/:curriculumId/folders/.*`, controllers.folderController.update);
    server.del(`${curriculaBasePath}/:curriculumId/folders/.*`, controllers.folderController.delete);
}
